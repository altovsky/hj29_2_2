...
function getContactsData() {
  ...
  document.querySelector('.contacts-list').innerHTML = contacts.reduce((val, contact) => {
    return val + `<li data-email=${contact.email} data-phone = "${contact.phone}"><strong>${contact.name}</strong></li>`
  },'');
}
